...
| 実機検証 | 進行中 | DocumentViewer / Window A Socket.IO 実機テスト (Pi5 `send_scan.py` → Window A listener → DocumentViewer 表示まで 2025-11-13 に確認済み。Pi Zero からの実機スキャンを次フェーズで実施) | docs/test-notes/2025-11/window-a-socket-plan.md, docs/test-notes/2025-11/window-a-demo.md, window_a/** |
