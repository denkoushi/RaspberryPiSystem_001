...
| 実機検証 | 進行中 | DocumentViewer / Window A Socket.IO 実機テスト (Window A psycopg3 反映と Pi4 venv 再構築を完了してから実施) | docs/test-notes/2025-11/window-a-socket-plan.md, docs/test-notes/2025-11/window-a-demo.md |
